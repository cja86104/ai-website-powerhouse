...
7. Never import npm packages other than "react", "react-dom", "framer-motion", "lucide-react", and "react-router-dom" — only those and relative paths are installed; anything else breaks the build.
