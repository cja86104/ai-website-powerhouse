/**
 * AI Website Powerhouse — forgot-password page (W2 Thu).
 *
 * Collects an email and triggers `requestPasswordReset`. The success
 * path deliberately does not reveal whether the address exists.
 */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#2d1b3d] to-[#4a1942] flex items-center justify-center p-4">
      <div className="bg-gradient-to-br from-[#2d1b3d] to-[#1a1a2e] rounded-2xl border border-orange-500/30 shadow-2xl w-full max-w-md p-8">
        ...
        <h2 className="text-xl font-semibold text-orange-100 mb-2">
          Reset your password
        </h2>
        <p className="text-sm text-orange-200/70 mb-6">
